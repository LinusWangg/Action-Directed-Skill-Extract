...
class TestSkillModules():
    def __init__(self, dataset_name, task):
        ...
        #Load Action Vae model
        action_vae_path = "results/saved_skill_models/" + dataset_name + "/action_vae.pth"
        self.action_vae = torch.load(action_vae_path, map_location=torch.device(self.device))
